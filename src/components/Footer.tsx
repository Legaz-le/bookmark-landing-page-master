const Footer = () => {
  return (
    <div className="relative  py-1 ">
      <div
        className="absolute  inset-0 bg-Blue-950 h-full w-screen -z-10"
        style={{
          left: "50%",
          right: "50%",
          marginLeft: "-50vw",
      ...
      <div className="container mx-auto px-4 flex justify-between items-center mt-10">
        <div className="flex items-center">
          ...
          <nav className="hidden md:flex gap-8 ml-10 ">
            <a className="text-white font-display hover:text-Red-400 transition-colors uppercase cursor-pointer">
              Features
            </a>
            <a className="text-white font-display hover:text-Red-400 transition-colors uppercase cursor-pointer">
              Pricing
